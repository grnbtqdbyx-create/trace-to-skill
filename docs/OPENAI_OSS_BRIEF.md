...
- One-command package: npx trace-to-skill@0.1.61
- Open-source license: Apache-2.0
- Codex readiness doctor: ready, 100/100, 0 failed checks.
- Public fixture benchmark: pass, 28 cases.
