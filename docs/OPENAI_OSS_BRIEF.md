...
- One-command package: npx trace-to-skill@0.1.65
- Open-source license: Apache-2.0
- Codex readiness doctor: ready, 100/100, 0 failed checks.
- Public fixture benchmark: pass, 32 cases.
