...
- whether MCP startup inputs are obviously broken before launch, including wrong `mcp_servers` casing, missing commands, missing `cwd`, placeholder env values, or unresolved `$VARS`
