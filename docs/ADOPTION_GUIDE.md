...
2. Run `trace-to-skill lint-agents .` to check `AGENTS.md`, tool-specific instruction files, instruction includes, nested AGENTS visibility, MCP capability risk, JSON/TOML static MCP startup inputs, and Codex config drift.
